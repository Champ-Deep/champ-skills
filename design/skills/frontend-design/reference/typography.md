...
## Curated Font Pairings (57 Pairings)

### Category 1: Editorial / Publishing
1. **Playfair Display + Source Sans 3** — Classic editorial, magazine feel
2. **Cormorant Garamond + Jost** — Luxury editorial, fashion
3. **Libre Baskerville + Libre Franklin** — Newspaper authority
4. **Lora + Nunito** — Warm editorial, blog
5. **Merriweather + Open Sans** — Long-form reading

### Category 2: Tech / SaaS / Developer
6. **Space Grotesk + Space Mono** — Developer tool, code-adjacent
7. **DM Sans + DM Mono** — Clean SaaS, professional
8. **IBM Plex Sans + IBM Plex Mono** — Enterprise tech
9. **Geist + Geist Mono** — Modern dev tool (Vercel-style)
10. **Inter + JetBrains Mono** — Functional dashboard

### Category 3: Creative / Agency
11. **Syne + Syne Mono** — Bold creative agency
12. **Cabinet Grotesk + Satoshi** — Modern studio
13. **Clash Display + Switzer** — Edgy creative
14. **Bebas Neue + Barlow** — Bold branding
15. **Neue Haas Grotesk + Helvetica Now** — Swiss minimalism

### Category 4: Startup / Consumer
16. **Outfit + Plus Jakarta Sans** — Friendly startup
17. **Nunito + Mulish** — Approachable consumer app
18. **Poppins + Hind** — Bright SaaS startup
19. **Raleway + Lato** — Lifestyle brand
20. **Quicksand + Source Sans 3** — Casual, welcoming

### Category 5: Luxury / Premium
21. **Bodoni Moda + Montserrat** — High fashion
22. **Canela + Aktiv Grotesk** — Premium brand
23. **Freight Display + Freight Text** — Refined luxury
24. **Ogg + Brown Pro** — Editorial luxury
25. **Times New Roman + Gill Sans** — Institutional authority

### Category 6: Minimal / Functional
26. **Helvetica Neue + Helvetica Neue** — Pure Swiss
27. **Aktiv Grotesk + Aktiv Grotesk** — Single-family hierarchy
28. **Neue Montreal + Neue Montreal** — Neo-grotesque
29. **Graphik + Graphik** — Neutral workhorse
30. **National 2 + National 2** — Humanist single-family

### Category 7: Warm / Humanist
31. **Tiempos Headline + Tiempos Text** — Humanist editorial
32. **Domaine Display + Domaine Text** — Elegant serif
33. **Signifier + Söhne** — Literary warmth
34. **Portrait + Calibre** — Editorial warmth
35. **Garamond Premier + Gill Sans** — Classic academic

### Category 8: Bold / Expressive
36. **Anton + Roboto Condensed** — High-impact headlines
37. **Oswald + Open Sans** — Sports/action
38. **Fjalla One + Cantarell** — Bold utility
39. **Alfa Slab One + Source Serif** — Retro bold
40. **Righteous + Raleway** — Playful bold

### Category 9: Retro / Vintage
41. **Abril Fatface + Crimson Text** — Victorian editorial
42. **Lobster + Lato** — Retro casual
43. **Fredoka One + Nunito** — Playful retro
44. **Pacifico + Quicksand** — Vintage friendly
45. **Permanent Marker + Patrick Hand** — Handmade

### Category 10: Geometric / Modern
46. **Futura + Georgia** — Mid-century modern
47. **Circular + New York** — Premium geometric
48. **Proxima Nova + Lora** — Neutral + warmth
49. **Brandon Grotesque + Brandon Text** — Geometric family
50. **Acumin Pro + Utopia** — Contemporary editorial

### Category 11: Monospace / Terminal
51. **Fira Code + Fira Sans** — Developer-forward
52. **Hack + Source Sans Pro** — Code-centric
53. **Iosevka + Inter** — Dense code + clean UI
54. **Berkeley Mono + Helvetica Now** — Premium mono
55. **Commit Mono + DM Sans** — Minimal code aesthetic

### Category 12: International / Multi-script
56. **Noto Sans + Noto Serif** — Universal multi-language
57. **Source Han Sans + Source Serif** — CJK-inclusive
